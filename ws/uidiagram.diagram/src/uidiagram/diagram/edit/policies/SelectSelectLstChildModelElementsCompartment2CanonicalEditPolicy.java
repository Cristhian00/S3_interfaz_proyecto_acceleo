 ...
 * @generated
 */
public class SelectSelectLstChildModelElementsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getSelectSelectLstChildModelElementsCompartment_7010SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getSelectSelectLstChildModelElementsCompartment_7010SemanticChildren((View) getHost().getModel());
