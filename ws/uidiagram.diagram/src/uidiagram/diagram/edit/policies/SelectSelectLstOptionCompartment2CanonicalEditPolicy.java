 ...
 * @generated
 */
public class SelectSelectLstOptionCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getSelect_LstOption();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getSelectSelectLstOptionCompartment_7014SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Option2EditPart.VISUAL_ID == UidiagramVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getSelectSelectLstOptionCompartment_7014SemanticChildren((View) getHost().getModel());
