 ...
 * @generated
 */
public class IFrameIFrameLstChildModelElementsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getIFrameIFrameLstChildModelElementsCompartment_7004SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getIFrameIFrameLstChildModelElementsCompartment_7004SemanticChildren((View) getHost().getModel());
