 ...
 * @generated
 */
public class SelectSelectLstOptionCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getSelectSelectLstOptionCompartment_7012SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getSelectSelectLstOptionCompartment_7012SemanticChildren((View) getHost().getModel());
