 ...
 * @generated
 */
public class SelectSelectLstChildModelElementsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getSelectSelectLstChildModelElementsCompartment_7009SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getSelectSelectLstChildModelElementsCompartment_7009SemanticChildren((View) getHost().getModel());
