 ...
 * @generated
 */
public class IFrameIFrameLstChildModelElementsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getIFrameIFrameLstChildModelElementsCompartment_7005SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getIFrameIFrameLstChildModelElementsCompartment_7005SemanticChildren((View) getHost().getModel());
