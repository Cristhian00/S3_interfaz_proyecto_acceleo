...
import uidiagram.diagram.edit.policies.OptionItemSemanticEditPolicy;
...
public class OptionEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OptionItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OptionTitleEditPart) {
			((OptionTitleEditPart) childEditPart).setLabel(getPrimaryShape().getFigureOptionLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(OptionTitleEditPart.VISUAL_ID));
	}
