...
public class Button2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ButtonTitle2EditPart) {
			((ButtonTitle2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ButtonTitle2EditPart.VISUAL_ID));
	}
