...
import uidiagram.diagram.edit.policies.ObjectItemSemanticEditPolicy;
...
public class ObjectEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ObjectTitleEditPart) {
			((ObjectTitleEditPart) childEditPart).setLabel(getPrimaryShape().getFigureObjectLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ObjectTitleEditPart.VISUAL_ID));
	}
