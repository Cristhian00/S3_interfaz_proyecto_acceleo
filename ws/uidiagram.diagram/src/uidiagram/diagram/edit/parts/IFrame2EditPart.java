 ...
 * @generated
 */
public class IFrame2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public IFrame2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new IFrameFigure();
	}

	/**
	* @generated
	*/
	public IFrameFigure getPrimaryShape() {
		return (IFrameFigure) primaryShape;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(IFrameTitle2EditPart.VISUAL_ID));
	}
