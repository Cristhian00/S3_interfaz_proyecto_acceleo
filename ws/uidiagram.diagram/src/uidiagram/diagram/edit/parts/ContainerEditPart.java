...
import uidiagram.diagram.edit.policies.ContainerItemSemanticEditPolicy;
...
public class ContainerEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ContainerTitleEditPart) {
			((ContainerTitleEditPart) childEditPart).setLabel(getPrimaryShape().getFigureContainerLabelFigure());
			return true;
		}
		if (childEditPart instanceof ContainerContainerLstChildModelElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getContainerLstChildModelElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ContainerContainerLstChildModelElementsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ContainerContainerLstChildModelElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getContainerLstChildModelElementsCompartmentFigure();
			pane.remove(((ContainerContainerLstChildModelElementsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ContainerContainerLstChildModelElementsCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ContainerTitleEditPart.VISUAL_ID));
	}
