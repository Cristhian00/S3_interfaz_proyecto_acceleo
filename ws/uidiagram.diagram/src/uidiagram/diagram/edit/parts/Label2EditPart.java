...
public class Label2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LabelTitle2EditPart) {
			((LabelTitle2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(LabelTitle2EditPart.VISUAL_ID));
	}
