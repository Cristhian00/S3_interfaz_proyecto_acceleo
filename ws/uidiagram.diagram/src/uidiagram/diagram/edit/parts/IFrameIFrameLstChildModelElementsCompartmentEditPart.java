...
import uidiagram.diagram.edit.policies.IFrameIFrameLstChildModelElementsCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.IFrameIFrameLstChildModelElementsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IFrameIFrameLstChildModelElementsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IFrameIFrameLstChildModelElementsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IFrameIFrameLstChildModelElementsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new IFrameIFrameLstChildModelElementsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new IFrameIFrameLstChildModelElementsCompartmentCanonicalEditPolicy());
	}
