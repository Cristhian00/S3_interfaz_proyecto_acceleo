...
import uidiagram.diagram.edit.policies.BlockquoteItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class BlockquoteEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public BlockquoteEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new BlockquoteItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof BlockquoteTitleEditPart) {
			((BlockquoteTitleEditPart) childEditPart).setLabel(getPrimaryShape().getFigureBlockquoteLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(BlockquoteTitleEditPart.VISUAL_ID));
	}
