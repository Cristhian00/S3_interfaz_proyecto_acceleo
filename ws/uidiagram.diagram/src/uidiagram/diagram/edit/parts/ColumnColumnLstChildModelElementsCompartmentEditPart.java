...
import uidiagram.diagram.edit.policies.ColumnColumnLstChildModelElementsCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.ColumnColumnLstChildModelElementsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ColumnColumnLstChildModelElementsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ColumnColumnLstChildModelElementsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ColumnColumnLstChildModelElementsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ColumnColumnLstChildModelElementsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ColumnColumnLstChildModelElementsCompartmentCanonicalEditPolicy());
	}
