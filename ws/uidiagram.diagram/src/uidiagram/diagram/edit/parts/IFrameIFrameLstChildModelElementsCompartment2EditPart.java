...
import uidiagram.diagram.edit.policies.IFrameIFrameLstChildModelElementsCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.IFrameIFrameLstChildModelElementsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IFrameIFrameLstChildModelElementsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IFrameIFrameLstChildModelElementsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IFrameIFrameLstChildModelElementsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new IFrameIFrameLstChildModelElementsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new IFrameIFrameLstChildModelElementsCompartment2CanonicalEditPolicy());
	}
