...
import uidiagram.diagram.edit.policies.ImageViewItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class ImageViewEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ImageViewEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ImageViewItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ImageViewTitleEditPart) {
			((ImageViewTitleEditPart) childEditPart).setLabel(getPrimaryShape().getFigureImageViewLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ImageViewTitleEditPart.VISUAL_ID));
	}
