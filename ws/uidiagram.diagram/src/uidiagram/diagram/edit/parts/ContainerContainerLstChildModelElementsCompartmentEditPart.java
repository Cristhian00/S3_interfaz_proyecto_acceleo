...
import uidiagram.diagram.edit.policies.ContainerContainerLstChildModelElementsCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.ContainerContainerLstChildModelElementsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ContainerContainerLstChildModelElementsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ContainerContainerLstChildModelElementsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ContainerContainerLstChildModelElementsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ContainerContainerLstChildModelElementsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ContainerContainerLstChildModelElementsCompartmentCanonicalEditPolicy());
	}
