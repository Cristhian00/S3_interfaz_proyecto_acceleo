...
public class TableEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TableTitleEditPart) {
			((TableTitleEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTableLabelFigure());
			return true;
		}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(TableTitleEditPart.VISUAL_ID));
	}
