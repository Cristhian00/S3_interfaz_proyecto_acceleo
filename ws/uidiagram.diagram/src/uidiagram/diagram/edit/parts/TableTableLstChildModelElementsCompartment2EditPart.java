...
import uidiagram.diagram.edit.policies.TableTableLstChildModelElementsCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.TableTableLstChildModelElementsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TableTableLstChildModelElementsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public TableTableLstChildModelElementsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.TableTableLstChildModelElementsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TableTableLstChildModelElementsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new TableTableLstChildModelElementsCompartment2CanonicalEditPolicy());
	}
