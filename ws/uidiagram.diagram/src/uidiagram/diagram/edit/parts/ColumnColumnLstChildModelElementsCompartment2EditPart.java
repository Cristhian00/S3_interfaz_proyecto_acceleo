...
import uidiagram.diagram.edit.policies.ColumnColumnLstChildModelElementsCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.ColumnColumnLstChildModelElementsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ColumnColumnLstChildModelElementsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ColumnColumnLstChildModelElementsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ColumnColumnLstChildModelElementsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ColumnColumnLstChildModelElementsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ColumnColumnLstChildModelElementsCompartment2CanonicalEditPolicy());
	}
