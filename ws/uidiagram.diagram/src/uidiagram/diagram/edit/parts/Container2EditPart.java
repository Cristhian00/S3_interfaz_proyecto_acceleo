...
import uidiagram.diagram.edit.policies.Container2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Container2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ContainerTitle2EditPart) {
			((ContainerTitle2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureContainerLabelFigure());
			return true;
		}
		if (childEditPart instanceof ContainerContainerLstChildModelElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getContainerLstChildModelElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ContainerContainerLstChildModelElementsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ContainerContainerLstChildModelElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getContainerLstChildModelElementsCompartmentFigure();
			pane.remove(((ContainerContainerLstChildModelElementsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ContainerContainerLstChildModelElementsCompartment2EditPart) {
			return getPrimaryShape().getContainerLstChildModelElementsCompartmentFigure();
		}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ContainerTitle2EditPart.VISUAL_ID));
	}
