...
import uidiagram.diagram.edit.policies.RadioItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class RadioEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public RadioEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RadioItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RadioTitleEditPart) {
			((RadioTitleEditPart) childEditPart).setLabel(getPrimaryShape().getFigureRadioLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(RadioTitleEditPart.VISUAL_ID));
	}
