 ...
 * @generated
 */
public class ColumnTitle3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ColumnTitle3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.Column_3022, getParserElement(),
					UidiagramVisualIDRegistry.getType(uidiagram.diagram.edit.parts.ColumnTitle3EditPart.VISUAL_ID));
		}
		return parser;
	}
