...
public class Table2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TableTitle2EditPart) {
			((TableTitle2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureTableLabelFigure());
			return true;
		}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(TableTitle2EditPart.VISUAL_ID));
	}
	...
	public class TableFigure extends RoundedRectangle {
		...
		*/
		...
		private void createContents() {
			...
			fTableLstChildModelElementsCompartmentFigure = new RectangleFigure();

			fTableLstChildModelElementsCompartmentFigure.setOutline(false);
