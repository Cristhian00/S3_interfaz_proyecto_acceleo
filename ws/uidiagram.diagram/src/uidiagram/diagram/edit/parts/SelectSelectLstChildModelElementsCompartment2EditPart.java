...
import uidiagram.diagram.edit.policies.SelectSelectLstChildModelElementsCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.SelectSelectLstChildModelElementsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SelectSelectLstChildModelElementsCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public SelectSelectLstChildModelElementsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.SelectSelectLstChildModelElementsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SelectSelectLstChildModelElementsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SelectSelectLstChildModelElementsCompartment2CanonicalEditPolicy());
	}
