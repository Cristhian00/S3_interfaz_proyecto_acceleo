...
public class Input2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputTitle2EditPart) {
			((InputTitle2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(InputTitle2EditPart.VISUAL_ID));
	}
