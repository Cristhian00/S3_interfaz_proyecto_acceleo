...
public class Column3EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ColumnTitle3EditPart) {
			((ColumnTitle3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureColumnLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ColumnTitle3EditPart.VISUAL_ID));
	}
