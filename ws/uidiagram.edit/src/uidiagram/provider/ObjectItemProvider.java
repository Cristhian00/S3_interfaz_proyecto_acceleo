...
/**
 * This is the item provider adapter for a {@link uidiagram.Object} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectItemProvider extends GraphicalIndividualItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Object_src_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Object_src_feature", "_UI_Object_type"),
				 UidiagramPackage.Literals.OBJECT__SRC,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((uidiagram.Object)object).getTitle();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(uidiagram.Object.class)) {
